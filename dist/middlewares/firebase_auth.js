...
const firebaseAuthMiddleware = async (req, res, next) => {
    ...
    try {
        ...
        ;
        console.log(decodedIdToken === null || decodedIdToken === void 0 ? void 0 : decodedIdToken.uid);
        ...
        next((new unauthorized_1.UnauthorizedException(e.toString(), root_1.ErrorCode.NOT_FOUND)));
    }
    next();
};
